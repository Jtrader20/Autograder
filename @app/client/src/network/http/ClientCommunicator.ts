...
export class ClientCommunicator {
    ...
    public async doPut<REQ extends AutograderRequest, RES extends AutograderResponse> (req: REQ | undefined, endpoint: string, headers?: Headers): Promise<RES> {
        return this.doRequest<REQ, RES>("PUT", req, endpoint, headers)
    }

    public async doGet<REQ extends AutograderRequest, RES extends AutograderResponse> (req: REQ | undefined, endpoint: string, headers?: Headers): Promise<RES> {
        return this.doRequest<REQ, RES>("GET", req, endpoint, headers)
    }
