...
export class A002 extends FileBaseSubmissionHandler {
    ...
    protected copytestfiles(submissiondir: string): void {
        // Copy main test file
        const testfile = path.resolve(__dirname, 'tests', 'A002.test.js')
        fs.copyFileSync(testfile, path.resolve(submissiondir, 'A002.test.js'))
